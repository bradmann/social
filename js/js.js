$(function() {
	...
	var graphconfig = {coulombConstant: 25000, damping: .01, springConstant: 2, theta: 1, timeStep: 1, width: 100 * width, height: 100 * height};
	...
	function load_json(data) {
		...
		if (data['nodes']['searches'].length + data['nodes']['urls'].length + data['nodes']['users'].length > 200) {
				graphics.zoomOut();
				xscale = .5;
				yscale = .5;
		}
